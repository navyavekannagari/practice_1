...
public class SeleniumCommands {
	...
	public static void main(String[] args) {
		...
		driver.getWindowHandle(); // This will help you to handle the multiple windows which is going to be
									// discussed in the 5th module
		driver.getPageSource(); // This is used to get the page source of the current URL and it is displayed in
								// the console panel
